                    ...
                    <div className="col-md-8 pe-2"> 
                        <div className="card-body">
                            ...
                            <div className='row'>
                                ...
                                <div className="col-sm-3 text-center p-2 border border-primary  mx-1 my-1">
                                    <h6>Magnesium</h6>
                                    <span>{Math.ceil(data.totalNutrients.MG.quantity)}</span>
                                    <span>{data.totalNutrients.MG.unit}</span>
                                </div>
                                <div className="col-sm-3 text-center p-2 border border-warning  mx-1 my-1">
                                    <h6>Water</h6>
                                    <span>{Math.ceil(data.totalNutrients.WATER.quantity)}</span>
                                    <span>{data.totalNutrients.WATER.unit}</span>
                                </div>
                                <div className="col-sm-3 text-center p-2 border border-success  mx-1 my-1">
                                    <h6>Vitamin D</h6>
                                    <span>{Math.ceil(data.totalNutrients.VITD.quantity)}</span>
                                    <span>{data.totalNutrients.VITD.unit}</span>
                                </div>
